...
public class LimboProtocol {
  ...
  public static void init() throws Throwable {
    register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
        ...
        createMapping(0x27, ProtocolVersion.MINECRAFT_26_3, true) // game_event
    );
    register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
        ...
        createMapping(0x2E, ProtocolVersion.MINECRAFT_26_3, true) // level_chunk_with_light
    );
    register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
        ...
        createMapping(0x26, ProtocolVersion.MINECRAFT_26_3, true) // forget_level_chunk
    );
    register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
        ...
        createMapping(0x63, ProtocolVersion.MINECRAFT_26_3, true) // set_default_spawn_position
    );
    register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
        ...
        createMapping(0x34, ProtocolVersion.MINECRAFT_26_3, true) // map_item_data
    );
    register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
        ...
        createMapping(0x41, ProtocolVersion.MINECRAFT_26_3, true) // player_abilities
    );
    register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
        ...
        createMapping(0x49, ProtocolVersion.MINECRAFT_26_3, true) // player_position
    );
    register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
        ...
        createMapping(0x69, ProtocolVersion.MINECRAFT_26_3, true) // set_experience
    );
    register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
        ...
        createMapping(0x14, ProtocolVersion.MINECRAFT_26_3, true)
    );
    register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
        ...
        createMapping(0x73, ProtocolVersion.MINECRAFT_26_3, true) // set_time
    );
    register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
        ...
        createMapping(0x60, ProtocolVersion.MINECRAFT_26_3, true) // set_chunk_cache_center
    );
    register(LIMBO_STATE_REGISTRY, PacketDirection.CLIENTBOUND,
        ...
        createMapping(0x89, ProtocolVersion.MINECRAFT_26_3, true) // update_tags
    );
    ...
    register(LIMBO_STATE_REGISTRY, PacketDirection.SERVERBOUND,
        ...
        createMapping(0x1F, ProtocolVersion.MINECRAFT_26_3, false)
    );
    register(LIMBO_STATE_REGISTRY, PacketDirection.SERVERBOUND,
        ...
        createMapping(0x1E, ProtocolVersion.MINECRAFT_26_3, false)
    );
    register(LIMBO_STATE_REGISTRY, PacketDirection.SERVERBOUND,
        ...
        createMapping(0x20, ProtocolVersion.MINECRAFT_26_3, false)
    );
    register(LIMBO_STATE_REGISTRY, PacketDirection.SERVERBOUND,
