...
public class StringComponent extends AbstractItemComponent<String> {

  @Override
  public void read(ByteBuf buf, ProtocolVersion version) {
    this.setValue(ProtocolUtils.readString(buf));
  }

  @Override
  public void write(ByteBuf buf, ProtocolVersion version) {
    ProtocolUtils.writeString(buf, this.getValue());
  }
}
