...
public class VarIntComponent extends AbstractItemComponent<Integer> {

  @Override
  public void read(ByteBuf buf, ProtocolVersion version) {
    this.setValue(ProtocolUtils.readVarInt(buf));
  }

  @Override
  public void write(ByteBuf buf, ProtocolVersion version) {
    ProtocolUtils.writeVarInt(buf, this.getValue());
  }
}
