...
public interface LimboPlayer {
  ...
  @Deprecated(forRemoval = true)
  default void setInventory(int slot, VirtualItem item, int count, int data, DataComponentMap map) {
  ...
  void setItem(int slot, VirtualItem item, int count, @Nullable DataComponentMap map);
  ...
  void setItem(int slot, VirtualItem item, int count, short data, @Nullable DataComponentMap map);

  void setItem(int slot, VirtualItem item, int count, short data, @Nullable CompoundBinaryTag nbt, @Nullable DataComponentMap map);
   ...
   */
  void setEntityData(int id, EntityData data);
